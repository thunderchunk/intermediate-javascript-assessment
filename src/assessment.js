...
context1 = function(myFn, context, param1, param2){
...
context2 = function(myFn, context, params){
...
context3 = function(myFn, context){
...
function Burrito(){
  ...
  this.eat = function(){return this.percentLeft -= 25}
}
...
Chimichanga.prototype.eat = function(){this.percentLeft -= 20;};
...
function subway(personName){
  return function addIngredient(x){
    return{
